...
const ProjectColumnsPage = () => {
  ...
  const projects = [
    ...
    { id: 4, img: "/job/ai-hedge.png", des: "Node-based AI workspace for live crypto market analysis", head: 'ASTRA (AI Hedge Fund)', link: 'https://hedge-scratch.vercel.app', techStack: "React, TypeScript, React Flow, TanStack Query, shadcn/ui, TailwindCSS, FastAPI, OpenAI, Binance API, yfinance, Pandas, MySQL" },
    { id: 5, img: "/ycdirectory.webp", des: "A Blog Application", head: 'YCDirectory (MERN)', link: 'https://ycdirectory-usman-haider.vercel.app/', techStack: "React, TypeScript, GraphQL (Apollo), Clerk Auth, Redux Toolkit, TanStack Query, Socket.IO, Express, MongoDB, Cloudinary, TailwindCSS" },
    { id: 6, img: "/insta.webp", des: "A social media application", head: 'Instagram (MERN)', link: 'https://instagram-usman-haider.vercel.app/', techStack: "React, Redux Toolkit, GSAP, Framer Motion, Express, MongoDB, Cloudinary, JWT, Resend, TailwindCSS" },
    { id: 7, img: "/brainwave.webp", des: "A Designing Clone", head: 'Brainwave (React)', link: 'https://brainwave-ochre-tau.vercel.app/', techStack: "React, GSAP, Framer Motion, Locomotive Scroll, React Router, TailwindCSS" },
    { id: 8, img: "/zentry.webp", des: "A Gaming Website", head: 'Zentry (React)', link: 'https://zentry-rosy.vercel.app/', techStack: "React, GSAP, React Parallax Tilt, React Use, TailwindCSS" }
  ];
