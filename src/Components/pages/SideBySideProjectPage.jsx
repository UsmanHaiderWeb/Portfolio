...
const SideBySideProjectPage = ({ nextPage }) => {
        ...
        gsap.to(bgChanger.current, {
            scrollTrigger: {
                ...
                onUpdate: (prop) => {
                    ...
                    if (prop.progress == 0) {
                        nextPage.current.style.backgroundColor = "#09090B"
                        nextPage.current.style.opacity = "0"
                    } else {
                        nextPage.current.style.backgroundColor = "#e2e2e2"
                        nextPage.current.style.opacity = "1"
                    }
    ...
    return (
        <div ref={bgChanger} className='w-full pb-[200px] mini:pb-[175px] mobile:pb-[150px] micro:pb-[120px] pt-[170px] mini:pt-[150px] mobile:pt-[130px] micro:pt-[100px]'>
